            ...
            try:
                  ...
                  for mapX in range(self.marsMap.width):
                        ...
                        for mapY in range(self.marsMap.height):
                              ...
                              self.mars_map[mapX].append({"x": mapX, "y": mapY, "hash": self.hashCoordinates(mapX, mapY), "isPassable": self.marsMap.is_passable_terrain_at(mapLoc), "karboniteCount": self.marsMap.initial_karbonite_at(mapLoc)})
